...
(function() {
  ...
  //-----------------------------------------------------------------------------------------------------------
  this._read_pids_and_window_ids = (require('./wid-from-pid'))._read_pids_and_window_ids.bind(this);

  this.get_pids_and_window_ids = (require('./wid-from-pid')).get_pids_and_window_ids.bind(this);

  this.window_id_from_pid = (require('./wid-from-pid')).window_id_from_pid.bind(this);

  this.wait_for_window_id_from_pid = (require('./wid-from-pid')).wait_for_window_id_from_pid.bind(this);
